...
const PublicInstanceProxyHandlers = {
  ...
  has({
    ...
    let normalizedProps, cssModules2;
    return !!(accessCache[key] || data !== EMPTY_OBJ && key[0] !== "$" && hasOwn(data, key) || hasSetupBinding(setupState, key) || (normalizedProps = propsOptions[0]) && hasOwn(normalizedProps, key) || hasOwn(ctx, key) || hasOwn(publicPropertiesMap, key) || hasOwn(appContext.config.globalProperties, key) || (cssModules2 = type.__cssModules) && cssModules2[key]);
  },
...
const palette = {
  black: ["#1A1A1A", "#3D3D3D", "#535353", "#8F8F8F"]
};
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__cssModules", cssModules]]);
class Theme {
  constructor({ id, name }) {
    this.id = id;
    this.name = name;
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function joinQueue() {
      wsCon.send(__props.theme.id);
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        onClick: _cache[0] || (_cache[0] = ($event) => joinQueue())
      }, [
        createBaseVNode("span", null, toDisplayString(_ctx.theme.name), 1),
        createBaseVNode("p", null, "Players Queued: " + toDisplayString(unref(playersQueued)), 1)
      ]);
    };
  }
});
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      wsCon.listen((e) => {
        ...
        router2.push("/chatroom");
      });
      console.log(wsCon);
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ol", null, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(defaultThemes), (t) => {
          return openBlock(), createElementBlock("li", null, [
            createVNode(QueueButton, { theme: t }, null, 8, ["theme"])
          ]);
        }), 256))
      ]);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        dayTime.value ? (openBlock(), createElementBlock("form", {
          key: 0,
          onSubmit: withModifiers(sendMessage, ["prevent"]),
          class: "chat-input"
        }, [
          withDirectives(createBaseVNode("input", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => newMessage.value = $event),
            required: "",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("ul", _hoisted_2$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(chat_box.value, (message) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const end_time = ref(Date.now() + 5 * 60 * 1e3);
    ...
    const time_left = computed(() => {
      ...
      return diff > 0 ? Math.floor(diff / 1e3) : 0;
    });
    function show_time() {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        _cache[0] || (_cache[0] = createBaseVNode("h1", null, "YOU ARE", -1)),
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("p", null, toDisplayString(role.value), 1)
        ]),
        createBaseVNode("p", null, "Day: " + toDisplayString(day.value), 1),
        createBaseVNode("p", null, "Time until nightfall: " + toDisplayString(show_time()), 1),
        createBaseVNode("p", null, "Players remaining: " + toDisplayString(players.value), 1)
      ]);
    };
  }
};
const GameInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7f2a0bc7"]]);
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1, [
        createVNode(GameInfo),
        createVNode(ChatBox, { ws: _ctx.ws }, null, 8, ["ws"])
      ]);
    };
  }
};
